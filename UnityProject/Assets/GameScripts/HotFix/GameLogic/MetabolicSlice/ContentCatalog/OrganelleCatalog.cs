    ...
    public static class OrganelleCatalog
    {
        ...
        private static readonly Dictionary<string, OrganelleDef> _defs = new Dictionary<string, OrganelleDef>
        {
            ...
            ["org_boomer"] = new OrganelleDef("org_boomer", "回旋荚", OrganelleRole.Sink, OrganelleAttachTarget.Slot,
                ...
                isCarrier: true, attackMethod: true, attackFamily: "Boomerang",
            ...
            ["org_synapsearc"] = new OrganelleDef("org_synapsearc", "放电突触", OrganelleRole.Sink, OrganelleAttachTarget.Slot,
                ...
                isCarrier: true, attackMethod: true, attackFamily: "Chain",
                description: "攻击方式：跳到附近下一只。"),
            ...
            ["org_wave"] = new OrganelleDef("org_wave", "胞质浪", OrganelleRole.Sink, OrganelleAttachTarget.Slot,
                null, "org/wave", () => new CompositeModule("wave_attack", "胞质浪攻击",
                    new SpreadModule(180f), new Grow(1.3f), new Actuator(shape: "Wave", pattern: AttackPattern.Wave)),
                isCarrier: true, attackMethod: true, attackFamily: "Wave",
                description: "攻击方式：朝面向打出新月浪。"),
