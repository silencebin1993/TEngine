...
> **Retired / 2026-09-19：** 旧题材资产规范不适用于《地球归还》Demo，不得继续据此生成玩家可见美术。现行入口见 [DesignDocs README](../README.md)。

> **用途：** 先用 AI 批量出 **静图 PNG**，再考虑动画。  
> **服从：** 《代谢切片-冻结总案-基元与美术》**0.1 冻结版**——命名 / ArtId / 尺寸以冻结总案为准；膜器/管壁已并入器官（仅 `org/`）。  
